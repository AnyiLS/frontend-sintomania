...
export const World1Container = styled.div`
    ...
    .monster-container {
        ...
        .score {
            ...
            background-image: url('https://juegoseml.co/images-recover/avatar-1.webp');
            background-size: 100% 100%;
        ...
        .cat-counter {
            ...
            background-image: url('https://juegoseml.co/images-recover/boton-gato.webp');
            background-size: 100% 100%;
        ...
        .sun-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/boton-sol.webp');
            background-size: 100% 100%;
        ...
        .bacterium-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/boton-bacteria.webp');
            background-size: 100% 100%;
        ...
        .apple-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/boton-manzana.webp');
            background-size: 100% 100%;
