...
export const World1Container = styled.div`
    ...
    .monster-container {
        ...
        .score {
            ...
            background-image: url('https://juegoseml.co/images-recover/score-grey.webp');
            background-size: 100% 100%;
        ...
        .cat-counter {
            ...
            background-image: url('https://juegoseml.co/images-recover/cat-grey.webp');
            background-size: 100% 100%;
        ...
        .sun-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/sun-grey.webp');
            background-size: 100% 100%;
        ...
        .bacterium-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/bacterium-grey.webp');
            background-size: 100% 100%;
        ...
        .apple-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/apple-grey.webp');
            background-size: 100% 100%;
