...
export const World1Container = styled.div`
    ...
    .monster-container {
        ...
        .score {
            ...
            background-image: url('https://juegoseml.co/images-recover/profile-yellow.png');
            background-size: 100% 100%;
        ...
        .cat-counter {
            ...
            background-image: url('https://juegoseml.co/images-recover/cat-yellow.png');
            background-size: 100% 100%;
        ...
        .sun-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/sun-yellow.png');
            background-size: 100% 100%;
        ...
        .bacterium-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/bacterium-yellow.png');
            background-size: 100% 100%;
        ...
        .apple-counter {
            ${tw`w-full p-[10% 0] flex justify-end pr-[23%]`}
            background-image: url('https://juegoseml.co/images-recover/apple-yellow.png');
            background-size: 100% 100%;
