...
const Worlds = () => {
    ...
    useEffect(() => {
        ...
        localStorage.getItem('isPauseAudio').then((res) => {
            if (res === "false") {
                audio.play();
            }
        });
    ...
    const muteSound = () => {
        if (!pausa) {
            setPausa(true);
            sound.pause();
            localStorage.setItem('isPauseAudio', JSON.stringify(true))
        } else {
            setPausa(false);
            sound.play();
            localStorage.setItem('isPauseAudio', JSON.stringify(false))
        }
    };
                ...
                <RegisterContent>
                    <div className="relative">
                        ...
                        {userT === '1' ? (
                            ...
                            <div className="absolute top-[16%] left-[8.6%] w-[33.6%]">
                                <img
                                    src="https://juegoseml.co/images-recover/key.png"
                                    alt=""
                                    style={{
                    ...
                    >
                        <img
                            src="https://juegoseml.co/images-recover/photo.webp"
                            alt="usuario"
                        />
                        <img
                            src={login ? login.image_url : 'https://juegoseml.co/images-recover/photo.webp'}
                            alt=""
                    ...
                    {/* boton score */}
                    <div
                        className="max-w-[35%] absolute bottom-[14%] right-0"
                        onClick={() => setScore(true)}
                    >
                        <img
                            src="https://juegoseml.co/images-recover/boton-score.webp"
                            alt="boton-score"
                        />
                    </div>
                    {/* boton score */}
                    ...
                    <div className="max-w-[35%] absolute bottom-[13%] left-[-1px]">
                        <img
                            src={cerrar}
                            alt="boton-sonido1"
