  ...
  return (
    <HomeStyles.Background>
      ...
      <div className="button mt-0">
        <RegisterContent>
          <div className="register-content max-h-[80%]">
            <div className="register-path">
              <div className="input-container mb-[5px] overflow-auto">
                <p className="text-[15px] font-bold uppercase">POLÍTICA DE PRIVACIDAD </p>
                <small>
                  El presente Política de Privacidad establece los términos en
                  que Sintomania usa y protege la información que es
                  proporcionada por sus usuarios al momento de utilizar su
                  juego. Esta compañía está comprometida con la seguridad de los
                  ...
                  cambios. datos interesantes.
                </small>
                <p className="mt-[20px] font-bold uppercase">Información que es recogida</p>
                <small>
                ...
                <p className="mt-[20px] font-bold uppercase">Uso de la información recogida</p>
                <small>
                  ...
                  de nuestro sitio con ofertas especiales, nuevos productos y
                  ...
                  Sintomania está altamente comprometido para cumplir con el
                ...
                <p className="mt-[20px] font-bold uppercase">Cookies </p>
                <small>
                  ...
                  únicamente para análisis estadístico y después la información
                  se elimina de forma permanente. Usted puede eliminar las
                  cookies en cualquier momento desde su ordenador. Sin embargo
                  las cookies ayudan a proporcionar un mejor servicio de los
                  sitios web, estás no dan acceso a información de su ordenador
                  ni de usted, a menos de que usted así lo quiera y la
                  proporcione directamente . Usted puede aceptar o negar el uso
                  de cookies, sin embargo la mayoría de navegadores aceptan
                  cookies automáticamente pues sirve para tener un mejor
                  servicio web. También usted puede cambiar la configuración de
                  su ordenador para declinar las cookies. Si se declinan es
                  posible que no pueda utilizar algunos de nuestros servicios.
                </small>
                <p className="mt-[20px] font-bold uppercase">Enlaces a Terceros </p>
                <small>
                ...
                <p className="mt-[20px] font-bold uppercase">Control de su información personal </p>
                <small>
                  ...
                  electrónico.  En caso de que haya marcado la opción de recibir
                  nuestro boletín o publicidad usted puede cancelarla en
                  cualquier momento. Esta compañía no venderá, cederá ni
                  distribuirá la información personal que es recopilada sin su
                  consentimiento, salvo que sea requerido por un juez con un
                  orden judicial. Sintomania Se reserva el derecho de cambiar
                  los términos de la presente Política de Privacidad en
                  cualquier momento.
                </small>
              </div>
              <div className="button-container">
                <button id="button-form" onClick={() => router("/menu")}>
                  Volver
                </button>
              </div>
            </div>
