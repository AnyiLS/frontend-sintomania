      ...
      <div className="button" style={{ marginTop: 0 }}>
        <StyledContainerNiveles2>
          <div className="relative mobile:max-w-[320px] mini-tablet:max-w-[380px] tablet:max-w-[500px] w-full">
            ...
            >
              <img src="https://juegoseml.co/images-recover/grey-monster.gif" alt="" />
            </a>
            ...
            >
              <img src="https://juegoseml.co/images-recover/monster-grey-2.gif" alt="" />
              {levels.level2 && (
                <img
            ...
            >
              <img src="https://juegoseml.co/images-recover/monster-grey-3.gif" alt="" />
              {levels.level3 && (
                <img
                  src="https://juegoseml.co/images-recover/candado.webp"
                  alt=""
