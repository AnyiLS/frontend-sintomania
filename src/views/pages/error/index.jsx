...
const Lograste = () => {
  ...
  const [text, setText] = useState("https://juegoseml.co/images-recover/error-1.webp");
  const [sound, setSound] = useState(null);
  const [grap, setGrap] = React.useState("https://juegoseml.co/images-recover/grap-blue.webp");

  //sonidos
  useEffect(() => {
    let audio = new Audio("https://juegoseml.co/images-recover/sonidos/candy-crush.mp3.wav");
    setSound(audio);
    audio.play();
      ...
      <div className="button" style={{ marginTop: 0 }}>
        <StyledContainerError>
          <div className="relative flex justify-center">
            <img src={text} className="w-[90%] max-w-[450px]" id="cambio" />
