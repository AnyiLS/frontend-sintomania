...
const Siguientenivel1 = () => {
  ...
  const [text, setText] = useState("https://juegoseml.co/images-recover/siguiente-1.png");
  ...
  useEffect(() => {
    switch (level) {
      case "2":
        ...
        setText("https://juegoseml.co/images-recover/text-next-grey.png");
  ...
  return (
    ...
    >
      ...
      <div className="button" style={{ marginTop: 0 }}>
        <StyledContainersiguientenivel1 onClick={() => router("/worlds")}>
          <div className="relative flex justify-center">
            <img src={text} className="w-[90%] max-w-[500px]" id="cambio" alt="Blue"/>
          </div>
