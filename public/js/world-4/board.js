...
var Board4 = function (size) {
    ...
    */
    ...
    this.addRandomCandy = function (row, col, spawnRow, spawnCol) {
        ...
        var random_color = Math.floor(Math.random() * Candy4[`colors${item}`].length);
        var candy = new Candy4(Candy4[`colors${item}`][random_color], candyCounter++);
        this.add(candy, row, col, spawnRow, spawnCol);
    };
