if (window.location.pathname.includes("/world-2")) {
    setTimeout(() => {
        ...
        if (
            ...
            board = new Board2($.getUrllet("size"));
        } else {
            board = new Board2(DEFAULT_BOARD_SIZE);
        }

        // load a rule
        rules = new Rules2(board);
        ...
        $(document).ready(function () {
            ...
            localStorage.setItem("bacterium", JSON.stringify(bacterium));
            localStorage.setItem("apple", JSON.stringify(apple));
            localStorage.setItem("nube", JSON.stringify(flower));
            localStorage.setItem("flower", JSON.stringify(nube));
        ...
        $(board).on("add", function (e, info) {
            console.log(info)
                ...
                if(info.candy.color === "nube" || info.candy.color === "flower") {
                    img.src = "https://juegoseml.co/images-recover/" + candy.toString() + "-grey.gif";
                } else {
                    img.src = "https://juegoseml.co/images-recover/" + candy.toString() + "-grey-static.webp";
                }
                ...
                let candySizeHeight = document.getElementById("canvas")
                ...
                let startTop =
                    0 - (board.boardSize - top / candySize) * candySize;
        ...
        $(board).on("remove", function (e, info) {
            if (window.location.pathname.includes("/world-2")) {
                ...
                } else if (info.candy.color === "apple") {
                    let value = parseInt(
