if (window.location.pathname.includes("/world-3")) {
    setTimeout(() => {
        ...
        if (
            ...
            board = new Board3($.getUrllet("size"));
        } else {
            board = new Board3(DEFAULT_BOARD_SIZE);
        }

        // load a rule
        rules = new Rules3(board);
        ...
        $(document).ready(function () {
            ...
            document.getElementById("bacterium-counter").innerText = 10;
        ...
        $(board).on("add", function (e, info) {
            ...
            if(info.candy.color === "nube" || info.candy.color === "flower") {
                img.src = "https://juegoseml.co/images-recover/" + candy.toString() + "-purple.gif";
            } else {
                img.src = "https://juegoseml.co/images-recover/" + candy.toString() + "-purple.png";
            }
