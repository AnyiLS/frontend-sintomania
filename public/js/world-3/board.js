...
var Board3 = function (size) {
    ...
    */
    ...
    this.addRandomCandy = function (row, col, spawnRow, spawnCol) {
        ...
        var random_color = Math.floor(Math.random() * Candy3[`colors${item}`].length);
        var candy = new Candy3(Candy3[`colors${item}`][random_color], candyCounter++);
        this.add(candy, row, col, spawnRow, spawnCol);
    };
